<template>
  <div>
    <section id="contact" class="py-24 bg-gray-100 text-gray-900 dark:bg-black dark:bg-opacity-95 dark:text-gray-100">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
            <div class="flex items-center lg:mb-0 mb-10">
                <div class="">
                    <h4 class="text-4xl font-bold leading-6 mb-4 lg:text-left text-center"># Contact Us</h4>
                    <h2 class=" sm:text-xl font-light leading-10 mb-9 lg:text-left text-center">Reach Out To Us</h2>
                    <form action="">
                        <input type="text" class="w-full h-14 shadow-sm text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-3xl border border-gray-200 focus:outline-none py-2 px-4 mb-4" placeholder="Name">
                        <input type="email" class="w-full h-14 shadow-sm text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-3xl border border-gray-200 focus:outline-none py-2 px-4 mb-4" placeholder="Email">
                        <input type="text" class="w-full h-14 shadow-sm text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-3xl border border-gray-200 focus:outline-none py-2 px-4 mb-4" placeholder="Phone">
                        <textarea name="" id="text" class="w-full h-44 shadow-sm resize-none text-gray-600 placeholder-text-400 text-lg font-normal leading-7 rounded-3xl border border-gray-200 focus:outline-none px-4 py-4 mb-8" placeholder="Message"></textarea>
                    <button class="w-full h-12 text-center text-white text-base font-semibold leading-6 rounded-3xl bg-indigo-600 shadow transition-all duration-700 hover:bg-indigo-800">Submit</button>
                    </form>
                </div>
            </div>
            <div class="lg:max-w-xl w-full h-[600px] flex items-center justify-center  bg-cover bg-no-repeat bg-[url('https://pagedone.io/asset/uploads/1696245837.png')] ">
                <div class="">
                    <div class="lg:w-96 w-auto h-auto   bg-white shadow-xl lg:p-6 p-4">
                        ...
                        <img src="../images/logo2.png" class="h-14 transition-all flex text-center justify-center duration-500 mb-4" alt="Logo">
                    </div>
                        <a href="javascript:;" class="flex items-center mb-6">
                            ...
                            <h5 class="text-black text-base font-normal leading-6 ml-5">01020025648</h5>
                        </a>
                        <a href="javascript:;" class="flex items-center mb-6">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h5 class="text-black text-base font-normal leading-6 ml-5">0x01source@gmail.com</h5>
                        </a>
                        <a href="javascript:;" class="flex items-center mb-6">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h5 class="text-black text-base font-normal leading-6 ml-5">Cairo,Egypt</h5>
                        </a>
